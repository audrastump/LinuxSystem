...
text file. This reflected the update to the contents, which is what we predicted 
...
5) Every time that we add a new concrete file type we will need to modify the visitor design pattern to use these new concrete file types. 
